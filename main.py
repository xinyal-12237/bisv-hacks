...
def translation():
    ...
    if form.validate_on_submit():
        ...
        play(audio)
        return render_template('translation.html', form=form, message=message, userid=userid, langinput=langinput, langoutput=langoutput, data=data)
...
@app.route('/saved_transcriptions', methods=['GET', 'POST'])
